...
public class GongNotifierEmailPluginIntTest {
	...
	private GongNotifierEmailPlugin plugin;
	...
	public void setup() {
		...
		plugin = new GongNotifierEmailPlugin();
	...
	public void shouldNotifyMailingList() throws Exception {
		...
		DefaultGoPluginApiRequest req = new DefaultGoPluginApiRequest("", "", REQUEST_STAGE_STATUS);
